...
display_usage() {
    ...
    echo "  --cleanup:			  Cleans up previous modifications made by this script."
...
setup_kernelsu() {
    ...
    if [ ! -d "$GKI_ROOT/KernelSU" ]; then
        ...
        git clone https://github.com/hzzmonetvn/HzzMonet KernelSU
        echo "[+] Repository cloned from hzz Fork."
    fi
